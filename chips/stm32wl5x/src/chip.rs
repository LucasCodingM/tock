...
pub struct Stm32wl5xDefaultPeripherals<'a, ChipSpecs> {
...
impl<'a, ChipSpecs: ChipSpecsTrait> Stm32wl5xDefaultPeripherals<'a, ChipSpecs> {
    pub fn new(
...
impl<ChipSpecs: ChipSpecsTrait> InterruptService for Stm32wl5xDefaultPeripherals<'_, ChipSpecs> {
